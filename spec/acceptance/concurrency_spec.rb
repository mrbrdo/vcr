...
describe VCR do
  ...
  context 'when used in a multithreaded environment with an rspec context cassette', :with_monkey_patches => :excon do
    it 'properly stubs threaded requests', :vcr => { :cassette_name => 'foo' } do
      100.times do
